...
export class HomePage {
  ...
  constructor(private storage: StorageService, private api: ApiService, private alertController: AlertController) {}
    ...
    this.doughnutChart = new Chart(this.doughnutCanvas.nativeElement, {
      ...
      data: {
        ...
        datasets: [
          {
            label: 'Jumlah',
            data: [this.data.stok - this.data.ambil, this.data.ambil - this.data.klaim, this.data.klaim],
